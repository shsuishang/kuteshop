...
class ChainCategoryCriteria extends Criteria
{
    protected function condition(Builder $query): void
    {
        ...
        if ($chain_category_name = $this->request->get('chain_category_name')) {
            $query->where('chain_category_name', 'like', "%$chain_category_name%");
        }
    ...
    {
        return $model->orderBy('chain_category_sort', 'ASC')->orderBy('chain_category_id', 'ASC');
    }

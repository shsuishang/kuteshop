...
use Modules\Invoicing\Services\InvoicingControllerService;
use Modules\Invoicing\Repositories\Validators\InvoicingControllerValidator;
...
class InvoicingController extends BaseController
{
     ...
     * @return void
     */
    public function __construct(InvoicingControllerService $service)
    {
